...
| `auth.tls.keystoreFile`     | Location of the keystore file used by Keycloak pod                                     | `/opt/bitnami/keycloak/certs/keycloak.keystore.jks`                                                   |
| `auth.tls.truststoreFile`     | Location of the truststore file used by Keycloak pod                            | `/opt/bitnami/keycloak/certs/keycloak.truststore.jks`                                                   |
